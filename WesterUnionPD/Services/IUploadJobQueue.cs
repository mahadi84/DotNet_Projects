...
//ইউজার যখন ফাইল আপলোড করে, সবার আগে আপনাকে ডাটাবেসে একটি রেকর্ড তৈরি করতে হবে।
//  কেন? যাতে কাজের ট্র্যাকিং করা যায়। কাজ শুরু হওয়ার আগেই যদি ডাটাবেসে ডেটা না থাকে, তবে ব্যাকগ্রাউন্ড সার্ভিস প্রসেস করার জন্য কোনো রেফারেন্স পাবে না।
//  কি সেভ করবেন? জবের আইডি (Guid), ফাইলের পাথ (Path), এবং স্ট্যাটাস (Queued)।
